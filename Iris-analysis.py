...
def showCharts(data,labels,centers):
    ...
    ax1.set_title('Sepal'); ax2.set_title('Petal')
    
    ax1.set_xlabel('Chiều dài'); ax2.set_xlabel('Chiều dài')
    ax1.set_ylabel('Chiều rộng'); ax2.set_ylabel('Chiều rộng')
    
    ax1.set_xlim(0,data['sepal.length'].max()+1); ax2.set_xlim(0,data['petal.length'].max()+1)
    ax1.set_ylim(0,data['sepal.width'].max()+1); ax2.set_ylim(0,data['petal.width'].max()+1)
